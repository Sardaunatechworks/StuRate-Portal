...
export const LandingPage: React.FC = () => {
  ...
  const statsList = [
    { label: 'Registered Students', value: dbStats.totalStudents, suffix: '', icon: Users },
    { label: 'Courses Evaluated', value: dbStats.totalCourses, suffix: '', icon: BookOpen },
    { label: 'Active Lecturers', value: dbStats.totalLecturers, suffix: '', icon: GraduationCap },
    { label: 'Satisfaction Rate', value: dbStats.averageRating ? Math.round((dbStats.averageRating / 5) * 100) : 0, suffix: '%', icon: Star },
  ];
